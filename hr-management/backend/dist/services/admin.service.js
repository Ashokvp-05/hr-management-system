...
exports.getDatabaseStats = exports.rejectUser = exports.approveUser = exports.getPendingUsers = void 0;
...
const approveUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
...
const rejectUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    return db_1.default.user.update({
        where: { id: userId },
        data: { status: client_1.UserStatus.SUSPENDED }, // Or delete
    });
});
