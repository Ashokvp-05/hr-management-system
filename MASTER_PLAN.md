...
|-------|------------|-----------|
| **Frontend** | Next.js 14 (App Router) | SSR, excellent DX, Client-side fetching |
...
| **Backend** | Node.js + Express + TypeScript | Robust, scalable Restful API, Separation of concerns |
